          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="pt-32 pb-12 md:pt-40 md:pb-20">
              ...
              <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                <h1 className="h1 text-gray-200">Добро пожаловать!</h1>
              </div>
              ...
              <div className="max-w-sm mx-auto">
                ...
                <form>
                  ...
                  <div className="text-sm text-gray-500 text-center">
                         Я согласен с <Link to="#" className="underline text-gray-400 hover:text-gray-200 hover:no-underline transition duration-150 ease-in-out">Политикой конфиденциальности</Link> EVA.
                                </div>
                ...
                <div className="text-gray-400 text-center mt-6">
                  Уже используешь EVA? <Link to="signin" className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out">Войти</Link>
                </div>
              </div>
